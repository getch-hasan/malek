    ...
    return (
        <div className='grid grid-cols-4 gap-5'>
            <div className='grid'>
                ...
                <div className='relative items-center flex'> <input className='border p-3 rounded-lg bg-slate-100 w-full' type="text" placeholder='Enter your Email' /> <button className='absolute right-1 py-2 px-4 rounded-lg bg-green-300'> <FaArrowRightLong></FaArrowRightLong> </button> </div>
